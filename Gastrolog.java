 ...
 * @author lenovo
 */
public class Gastrolog implements Visitor{
    @Override
    ...
    public boolean visit(Dziecko dziecko) {        
        JOptionPane.showMessageDialog(null, "Przykro mi. Pomyliłeś lekarza. Twój pacjentka jest dzieckiem i wymaga innego rodzaju opieki. Teraz pacjent czuje się gorzej");
        return false;
    }

    @Override
    public boolean visit(Ciaza ciaza) {        
        JOptionPane.showMessageDialog(null, "Przykro mi. Pomyliłeś lekarza. Twoja pacjentka jest w ciążyi wymaga szczególnej opieki. Teraz pacjent czuje się gorzej");
        return false;
    }
    ...
    public boolean visit(BoleBrzucha brzuch) {        
        GastrologWyglad wyglad = new GastrologWyglad();
        return true;
    }
}
